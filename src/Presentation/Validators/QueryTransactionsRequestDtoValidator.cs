...
public class QueryTransactionsRequestDtoValidator : AbstractValidator<QueryTransactionsRequestDto>
{
    public QueryTransactionsRequestDtoValidator(IAccountService accountService)
    {
