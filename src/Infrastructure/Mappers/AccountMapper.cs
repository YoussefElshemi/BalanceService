...
public static class AccountMapper
{
    ...
    public static Account ToModel(this AccountEntity accountEntity)
    {
        return new Account
        {
            ...
            PendingDebitBalance = new PendingDebitBalance(accountEntity.PendingDebitBalance),
            PendingCreditBalance = new PendingCreditBalance(accountEntity.PendingCreditBalance),
