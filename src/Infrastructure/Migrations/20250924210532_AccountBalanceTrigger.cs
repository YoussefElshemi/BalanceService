                    ...
                    if (TG_OP = 'INSERT') then
                        if (new.""{IsDeletedColumn}"" = false) then
                            if (new.""{TransactionStatusIdColumn}"" = {TransactionStatusDraftId}) then
                                if (new.""{TransactionDirectionIdColumn}"" = {TransactionDirectionCreditId}) then
                                    update ""{TableNames.Accounts}""
                                    set ""{PendingCreditBalanceColumn}"" = ""{PendingCreditBalanceColumn}"" + new.""{AmountColumn}"",
                                        ""{UpdatedByColumn}"" = new.""{UpdatedByColumn}"",
                                        ""{UpdatedAtColumn}"" = new.""{UpdatedAtColumn}""
                                    where ""{AccountIdColumn}"" = new.""{AccountIdColumn}"";
                                elsif (new.""{TransactionDirectionIdColumn}"" = {TransactionDirectionDebitId}) then
                                    update ""{TableNames.Accounts}""
                                    set ""{PendingDebitBalanceColumn}"" = ""{PendingDebitBalanceColumn}"" + new.""{AmountColumn}"",
                                ...
                                if (new.""{TransactionDirectionIdColumn}"" = {TransactionDirectionCreditId}) then
                                    update ""{TableNames.Accounts}""
                                    set ""{LedgerBalanceColumn}"" = ""{LedgerBalanceColumn}"" + new.""{AmountColumn}"",
                                        ""{AvailableBalanceColumn}"" = ""{AvailableBalanceColumn}"" + new.""{AmountColumn}"",
                                        ""{UpdatedByColumn}"" = new.""{UpdatedByColumn}"",
                                        ""{UpdatedAtColumn}"" = new.""{UpdatedAtColumn}""
                                    where ""{AccountIdColumn}"" = new.""{AccountIdColumn}"";
                    ...
                    if (TG_OP = 'UPDATE') then
                        ...
                        if (old.""{AccountIdColumn}"" <> new.""{AccountIdColumn}"") then
                            ...
                            if (old.""{TransactionStatusIdColumn}"" = {TransactionStatusDraftId} and old.""{IsDeletedColumn}"" = false) then
                                if (old.""{TransactionDirectionIdColumn}"" = {TransactionDirectionCreditId}) then
                                    update ""{TableNames.Accounts}""
                                    set ""{PendingCreditBalanceColumn}"" = ""{PendingCreditBalanceColumn}"" - old.""{AmountColumn}"",
                                        ""{UpdatedByColumn}"" = new.""{UpdatedByColumn}"",
                                        ""{UpdatedAtColumn}"" = new.""{UpdatedAtColumn}""
                                    where ""{AccountIdColumn}"" = old.""{AccountIdColumn}"";
                                elsif (old.""{TransactionDirectionIdColumn}"" = {TransactionDirectionDebitId}) then
                                    update ""{TableNames.Accounts}""
                                    set ""{PendingDebitBalanceColumn}"" = ""{PendingDebitBalanceColumn}"" - old.""{AmountColumn}"",
                        ...
                        if (old.""{TransactionStatusIdColumn}"" = {TransactionStatusDraftId}
                            ...
                            if (new.""{TransactionDirectionIdColumn}"" = {TransactionDirectionCreditId}) then
                                update ""{TableNames.Accounts}""
                                set ""{PendingCreditBalanceColumn}"" = ""{PendingCreditBalanceColumn}"" - old.""{AmountColumn}"",
                                    ""{LedgerBalanceColumn}"" = ""{LedgerBalanceColumn}"" + new.""{AmountColumn}"",
                                    ""{AvailableBalanceColumn}"" = ""{AvailableBalanceColumn}"" + new.""{AmountColumn}"",
                                    ""{UpdatedByColumn}"" = new.""{UpdatedByColumn}"",
                                    ""{UpdatedAtColumn}"" = new.""{UpdatedAtColumn}""
                                where ""{AccountIdColumn}"" = new.""{AccountIdColumn}"";
                        ...
                        if (old.""{TransactionStatusIdColumn}"" = new.""{TransactionStatusIdColumn}"" 
                            ...
                            if (new.""{TransactionStatusIdColumn}"" = {TransactionStatusDraftId}) then
                                if (new.""{TransactionDirectionIdColumn}"" = {TransactionDirectionCreditId}) then
                                    update ""{TableNames.Accounts}""
                                    set ""{PendingCreditBalanceColumn}"" = ""{PendingCreditBalanceColumn}"" - old.""{AmountColumn}"" + new.""{AmountColumn}"",
                                        ""{UpdatedByColumn}"" = new.""{UpdatedByColumn}"",
                                        ""{UpdatedAtColumn}"" = new.""{UpdatedAtColumn}""
                                    where ""{AccountIdColumn}"" = new.""{AccountIdColumn}"";
                                elsif (new.""{TransactionDirectionIdColumn}"" = {TransactionDirectionDebitId}) then
                                    update ""{TableNames.Accounts}""
                                    set ""{PendingDebitBalanceColumn}"" = ""{PendingDebitBalanceColumn}"" - old.""{AmountColumn}"" + new.""{AmountColumn}"",
                                        ""{AvailableBalanceColumn}"" = ""{AvailableBalanceColumn}"" + old.""{AmountColumn}"" - new.""{AmountColumn}"",
                                        ""{UpdatedByColumn}"" = new.""{UpdatedByColumn}"",
                                        ""{UpdatedAtColumn}"" = new.""{UpdatedAtColumn}""
                                    where ""{AccountIdColumn}"" = new.""{AccountIdColumn}"";
                                end if;
